...
Each submission from the form in the app arrives as an issue on this
...
app — and then every word they wrote, verbatim, because the counted part
tells you what to build and the written part tells you why.

Runs on Actions (`.github/workflows/feedback.yml`) so it can reach GitHub;
locally it needs GITHUB_TOKEN and GITHUB_REPOSITORY in the environment.
